...
public LineChart( String applicationTitle , String chartTitle ) {
   ...
   private static DefaultCategoryDataset createDataset( ) {
      ...
      Map<Integer,Double> resRitter= TestQuality.qualityCircleSamples();
      Map<Integer,Double> resToussaint= TestQuality.qualityRectangleSamples();
      int i=0;
      int j=0;
   ...
   public static void main( String[ ] args ) throws IOException {
      ...
      File lineChart = new File( "QualityResults.jpeg" ); 
